          ...
          <div :class="{on:!loginWay}">
            <section>
              ...
              <section class="login_message">
                ...
                <img ref="captach" class="get_verification" src="http://localhost:4000/captcha" alt="captcha"
                     @click="resetCaptcha">
              </section>
            </section>
          </div>
...
export default {
  ...
  methods: {
    ...
    //更新验证码
    resetCaptcha() {
      this.$refs.captach.src = 'http://localhost:4000/captcha?time=' + new Date()
    }
  },
  computed: {
    rightPhone() {
